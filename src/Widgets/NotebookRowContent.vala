...
public class Notejot.NotebookRowContent : He.Bin {
    ...
    [GtkChild]
    public unowned He.TextField notebook_entry;
    ...
    async void on_edit_notebook_requested () {
        var vm = ((NotebookListView)MiscUtils.find_ancestor_of_type<NotebookListView>
                                                                                            (this)).view_model;
        var notes = vm.notes;
        var nvm = ((NotebookListView)MiscUtils.find_ancestor_of_type<NotebookListView>
                                                                                            (this)).nbview_model;
    ...
    void on_delete_button_clicked () {
        ...
        ((NotebookListView)MiscUtils.find_ancestor_of_type<NotebookListView>
            (this)).notebook_removal_requested (notebook);
    }
}
