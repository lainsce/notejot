[GtkTemplate (ui = "/io/github/lainsce/Notejot/logcontent.ui")]
public class Notejot.LogContent : Adw.Bin {
    [GtkChild]
    ...
    public LogContent (LogViewModel? vm) {
        Object (vm: vm);
    }
